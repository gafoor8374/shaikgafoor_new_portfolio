    ...
    <div ref={scrollRef}>
      ...
      >
        ...
        >
          ...
          <h2>
            I'm full-stack developer with a specialization in MERN stack with a
            passion for learning with an endless supply of enthusiasm, optimism
            and curiosity.
          </h2>
          <div className={styles.btn}>
            <a
              href="https://docs.google.com/document/d/1vdtWflZiImiIeBJuex96hGMtwOO8SJIf47oGywq4otg/edit?usp=sharing" // Resume
              target="blank"
            >
              <Button
                text={
        ...
        >
          <img
            src="https://iili.io/WjzUfs.png" //my Picture
            alt="Profile pic"
          />
        </div>
      </div>
